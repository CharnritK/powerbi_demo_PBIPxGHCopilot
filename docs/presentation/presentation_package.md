...
1. `docs/presentation/session_messaging.md`
2. `README.md`
3. `docs/operations/local-setup.md`
...
6. `demo-enterprise/bi-repo/powerbi/workspaces/regional-sales-trust-demo/pbip/demo_dataset.pbip`
7. `docs/presentation/presenter_demo_script.md`

## Repo Surfaces

- `docs/presentation/session_messaging.md`: source of truth for title, abstract, opening hook, and scope boundaries
...
- `demo-enterprise/bi-repo/powerbi/workspaces/regional-sales-trust-demo/pbip/`: local semantic model and report shell
...
1. Rehearse the opening hook and session scope from `docs/presentation/session_messaging.md`.
...
6. Capture any backup screenshots in a local presentation folder if you need an offline fallback.
...
- `notebooks/90_legacy_powerbi_rest_api_demo.ipynb` for an all-in-one workshop path
- local screenshots kept outside source control if you want an offline fallback
